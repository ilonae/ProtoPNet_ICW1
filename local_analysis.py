...
def main():
    ...
    log('prototype_info is: ' + str(os.path.join(load_img_dir, 'epoch-'+epoch_number_str, 'bb'+epoch_number_str+'.npy')))
    ...
    log('prototype_max_connection: ' + str(prototype_max_connection))
